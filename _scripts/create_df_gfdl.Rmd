...
```{r}
load('_data/GFDL/biascorr/files/ivt_hist_sdm.Rdata')
load('_data/GFDL/biascorr/files/ivt_ssp245_sdm.Rdata')
load('_data/GFDL/biascorr/files/ivt_ssp585_sdm.Rdata')
...
## checkpoint
save(df_hist, file = '_scripts/df_hist_1130.Rdata') #change 11/30: removed summer sequences
...
## checkpoint
save(df_ssp245, file = '_scripts/df_ssp245_1130.Rdata')
...
## checkpoint
save(df_ssp585, file = '_scripts/df_ssp585_1130.Rdata')
