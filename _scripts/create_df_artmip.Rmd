...
The dataframes are: a list of three-hour datasets, a list of twenty-four-hour datasets, and an overall event catalog. 
...
```{r}
ardtnames <- c(
  'brand','cascade','connect','gershunov','goldenson','guanwaliser','lbnl',
...
```{r}
load('_data/ARTMIP/Tier 1/ardt_rutz.Rdata')
