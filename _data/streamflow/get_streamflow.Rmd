...
For the list of gages above, we ran them through the interactive StreamStats online application manually and saved the results as individual files.

note: I've done 220/275 so far (9/30/22)
      ...
      weightmatrix <- 
        matrix(
          data = grid_convert %>% 
            ...
            pull(weight) %>% 
            rep(each = length(datelist)),
          nrow = length(datelist), ncol = length(convert))
      data.frame(
        date = datelist,
        cell = i,
